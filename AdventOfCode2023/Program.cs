...
var childTypes = Assembly.Load($"AdventOfCode2023").GetTypes().Where(myType => myType.IsClass && !myType.IsAbstract && myType.IsSubclassOf(typeof(Base)));

var concrteClass = childTypes.FirstOrDefault(x => x.Namespace == $"AdventOfCode2023.Day{day:00}");
